                ...
                <div class="col-lg-8">
                    <div class="mb-5">
                        <div class="section-title position-relative mb-5">
                            ...
                            <h1 class="display-4">Advanced UI / UX</h1>
                        </div>
                        <img class="img-fluid rounded w-100 mb-4" src="img/header.jpg" alt="Image">
                        <p>
                            Master the art of Advanced Web Design with our comprehensive online course. Designed for experienced web designers and aspiring professionals, this program will expand your skill set and elevate your design abilities to new heights. Dive into topics such as responsive design, user experience optimization, interactive animations, and dynamic content integration. With a combination of engaging video lectures and hands-on projects, you'll learn how to create visually stunning websites that captivate users and deliver exceptional user experiences across various devices and platforms.
                        </p>
                        
                        <p>
                            Throughout this course, you'll work with industry-standard tools and technologies like HTML5, CSS3, JavaScript, and popular web design frameworks such as Bootstrap and React. Discover advanced layout techniques, master responsive design principles, and gain insights into user-centered design approaches. By the end of the course, you'll have the skills to create sophisticated web designs and tackle complex design challenges. Join us today to unlock your potential as an advanced web designer and stay ahead in this dynamic field.
                        </p>
                    </div>
