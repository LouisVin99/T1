            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <p>
                            Master the art of Advanced Web Design with our comprehensive online course. Designed for experienced 
                            web designers and aspiring professionals, this program will expand your skill set and elevate your 
                            design abilities to new heights. Dive into topics such as responsive design, user experience optimization, 
                            interactive animations, and dynamic content integration.
                        </p>
                        
                        <p>
                            Throughout this course, you'll work with industry-standard tools and technologies like HTML5, CSS3, 
                            JavaScript, and popular web design frameworks such as Bootstrap and React. By the end of the course, 
                            you'll have the skills to create sophisticated web designs and tackle complex 
                            design challenges.
                        </p>
                    </div>
