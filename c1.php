            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="mb-5">
                        ...
                        <p>
                            Discover the exciting world of web design and development with our comprehensive online course for 
                            beginners. Whether you're an aspiring designer, developer, or simply curious about creating websites, 
                            this course is perfect for you. Learn the fundamentals of HTML, CSS, and JavaScript, and gain hands-on 
                            experience in building stunning and responsive web pages.
                        </p>
                        
                        <p>
                            Dive into the essentials of user experience (UX) design, explore popular frameworks and libraries, and 
                            master the art of creating visually appealing and functional websites. With step-by-step tutorials, 
                            interactive quizzes, and real-world projects, this course provides a solid foundation for launching 
                            your career or unleashing your creativity in the digital realm. Start your journey today and unlock 
                            the power to bring your web design dreams to life!
                        </p>
                    </div>

                    <h2 class="mb-3">Related Courses</h2>
                    <div class="owl-carousel related-carousel position-relative" style="padding: 0 30px;">
                        <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="course.php">
